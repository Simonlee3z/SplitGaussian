...
def select_template(image_selection_slider, video_state, interactive_state, mask_dropdown = True):
                ...
                with gr.Column():
                    ...
                    with gr.Row():
                        with gr.Row():
                            ...
                            clear_button_click = gr.Button(value="Clear clicks", interactive=True, visible=True)
...
iface.queue()
# iface.launch(debug=True, enable_queue=True, server_port=args.port, server_name="0.0.0.0", max_threads=1)
iface.launch(debug=True, server_port=args.port, server_name="0.0.0.0", max_threads=5,share=True)
