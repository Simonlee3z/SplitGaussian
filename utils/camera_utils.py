...
def loadCam(args, id, cam_info, resolution_scale):
    ...
    resized_depth = PILtoTorch(cam_info.depth, resolution=resolution)[0:1, :, :]
    ...
    return Camera(colmap_id=cam_info.uid, R=cam_info.R, T=cam_info.T,
                  ...
                  depth=resized_depth, gt_dynamic_mask=cam_info.gt_dynamic_mask, rayo = rays_o, rayd = rays_d)
